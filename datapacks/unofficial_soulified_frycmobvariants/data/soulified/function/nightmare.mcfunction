# Ghast - Tier 2 Mid-Game Mob (Dark Souls Overhaul)
# Base Stats: 16 HP → 32 HP (+100%)
...
# Effects: Strength II (fireball damage), Resistance II, Slow Falling I (flying), Fire Resistance II
