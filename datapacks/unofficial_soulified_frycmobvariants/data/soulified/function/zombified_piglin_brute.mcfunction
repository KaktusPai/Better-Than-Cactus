# Zombified Piglin Brute - Tier 3 Late-Game Mob (Mini-Boss) (Dark Souls Overhaul)
# Base Stats: 42 HP → 106 HP (+150%)
# Mini-Rage: Speed I + Strength 3 (30s) at 50% HP

# Increase max health by 150%
execute if score count_mobs soulified matches 0.. run attribute @s minecraft:generic.max_health base set 106
execute if score count_mobs soulified matches 0.. run data modify entity @s Health set value 106f
