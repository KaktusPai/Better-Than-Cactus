...
# Base Stats: 46 HP → 92 HP (+100%)
# Mini-Rage: Speed I + Strength 3 (30s) at 50% HP

# Increase max health by 100%
execute if score count_mobs soulified matches 0.. run attribute @s minecraft:generic.max_health base set 92
execute if score count_mobs soulified matches 0.. run data modify entity @s Health set value 92f
