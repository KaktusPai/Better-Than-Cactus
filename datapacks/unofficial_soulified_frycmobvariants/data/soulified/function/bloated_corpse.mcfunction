# Bloated Corpse - Tier 1 Early Game Mob (Dark Souls Overhaul)
# Base Stats: 18 HP → 28 HP (+50%)
# Mini-Rage: Speed I + Strength II (30s) at 50% HP

# Increase max health by 50%
execute if score count_mobs soulified matches 0.. run attribute @s minecraft:generic.max_health base set 26
execute if score count_mobs soulified matches 0.. run data modify entity @s Health set value 26f

# Effects: Strength II, Speed I, Resistance I, Fire Res I
